...
def process_xml_file(xml_file):
    ...
    new_file_name = "xml_files1/keystore.xml"
    with open(new_file_name, "w") as f:
        f.write(xml_data)

if __name__ == "__main__":
    xml_file = os.getcwd() + "/xml_files1/keystore_template.xml"
    crt_file = os.getcwd() + "/certs/IDevID_ee_ser.crt"
    pub_key_file = os.getcwd() + "/certs/IDevID_ee_ser_pub_key.pub"
    priv_key_file = os.getcwd() + "/certs/IDevID_ee_ser_key.key"
